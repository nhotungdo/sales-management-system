...
{
    /// <inheritdoc />
    public partial class InitialCreateAfterPull : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CategoryId = table.Column<int>(type: "int", nullable: false),
                    ImportPrice = table.Column<decimal>(type: "decimal(15,2)", nullable: false, defaultValue: 0m),
                    SellingPrice = table.Column<decimal>(type: "decimal(15,2)", nullable: false),
                    CoinPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, new DateTime(2026, 2, 24, 16, 17, 39, 491, DateTimeKind.Local).AddTicks(5658), "admin@gmail.com", null, null, true, false, null, "$2a$11$fkU7dyHOKhh0v2Dq6VuC3OZr8IQb2sprk1iU8RhckMbkaLgj98Ntm", null, "Admin", "admin" },
                    { 2, null, new DateTime(2026, 2, 24, 16, 17, 39, 666, DateTimeKind.Local).AddTicks(8603), "sale@gmail.com", null, null, true, false, null, "$2a$11$gr3vxS863mTV7AH2hye6f.H6Wa9B.igeyljtelOkltKyXSMPchfv6", null, "Sales", "sale" }
                });

            migrationBuilder.InsertData(
                table: "Employees",
                columns: new[] { "EmployeeId", "BasicSalary", "ChangeHistory", "ContractFile", "ContractType", "Department", "IsDeleted", "Position", "ShiftId", "StartWorkingDate", "UserId" },
                values: new object[] { 1, 5000000m, null, null, "Full-time", "Sales", false, "Sales Staff", null, new DateOnly(2026, 2, 24), 2 });
