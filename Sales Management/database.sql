...
CREATE TABLE WalletTransactions (
    ...
    TransactionType NVARCHAR(20) NOT NULL
                        CHECK (TransactionType IN ('Deposit', 'Payment', 'Refund', 'Adjustment')),
...
CREATE TABLE VipPackages (
    ...
    Features        NVARCHAR(MAX),   -- JSON hoặc chuỗi phân cách
    Icon            NVARCHAR(50),
...
-- 11. VipPackages
INSERT INTO VipPackages (Name, Tag, Description, Price, DurationMonth, DiscountPercent, Features, Icon, ColorCode, Status) VALUES
(N'Gói Bạc',  'Silver', N'Dành cho khách hàng thân thiết',   199000, 1,  5,  N'Giảm 5% mọi đơn hàng|Ưu tiên hỗ trợ',          'bi-star',        '#C0C0C0', 'Active'),
(N'Gói Vàng', 'Gold',   N'Dành cho khách hàng VIP',          499000, 3,  10, N'Giảm 10% mọi đơn hàng|Miễn phí vận chuyển',     'bi-star-fill',   '#FFD700', 'Active'),
(N'Gói Kim Cương', 'Diamond', N'Đặc quyền cao cấp nhất',    999000, 12, 20, N'Giảm 20% mọi đơn hàng|Quà tặng sinh nhật',      'bi-gem',         '#00BFFF', 'Active');
GO
