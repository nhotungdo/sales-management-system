...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SalesManagement.DAL.Entities.Category", b =>
                {
            ...
            modelBuilder.Entity("SalesManagement.DAL.Entities.ConversionAuditLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SalesManagement.DAL.Entities.Customer", b =>
                {
            ...
            modelBuilder.Entity("SalesManagement.DAL.Entities.Employee", b =>
                {
            ...
            modelBuilder.Entity("SalesManagement.DAL.Entities.EmployeeSalaryComponent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SalesManagement.DAL.Entities.InventoryTransaction", b =>
                {
            ...
            modelBuilder.Entity("SalesManagement.DAL.Entities.Invoice", b =>
                {
            ...
            modelBuilder.Entity("SalesManagement.DAL.Entities.LeaveRequest", b =>
                {
            ...
            modelBuilder.Entity("SalesManagement.DAL.Entities.Order", b =>
                {
                    b.Property<int>("OrderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SalesManagement.DAL.Entities.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("SalesManagement.DAL.Entities.OrderPromotion", b =>
                {
            ...
            modelBuilder.Entity("SalesManagement.DAL.Entities.Payroll", b =>
                {
            ...
            modelBuilder.Entity("SalesManagement.DAL.Entities.Product", b =>
                {
                    b.Property<int>("ProductId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SalesManagement.DAL.Entities.ProductImage", b =>
                {
            ...
            modelBuilder.Entity("SalesManagement.DAL.Entities.Promotion", b =>
                {
                    b.Property<int>("PromotionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SalesManagement.DAL.Entities.SalaryComponent", b =>
                {
                    b.Property<int>("SalaryComponentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SalesManagement.DAL.Entities.Shift", b =>
                {
                    b.Property<int>("ShiftId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SalesManagement.DAL.Entities.SystemSetting", b =>
                {
            ...
            modelBuilder.Entity("SalesManagement.DAL.Entities.TimeAttendance", b =>
                {
            ...
            modelBuilder.Entity("SalesManagement.DAL.Entities.User", b =>
                {
                    b.Property<int>("UserId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SalesManagement.DAL.Entities.VipPackage", b =>
                {
            ...
            modelBuilder.Entity("SalesManagement.DAL.Entities.Wallet", b =>
                {
            ...
            modelBuilder.Entity("SalesManagement.DAL.Entities.WalletTransaction", b =>
                {
            ...
            modelBuilder.Entity("SalesManagement.DAL.Entities.Category", b =>
                {
                    b.HasOne("SalesManagement.DAL.Entities.Category", "Parent")
            ...
            modelBuilder.Entity("SalesManagement.DAL.Entities.Customer", b =>
                {
                    b.HasOne("SalesManagement.DAL.Entities.User", "User")
                        .WithOne("Customer")
                        .HasForeignKey("SalesManagement.DAL.Entities.Customer", "UserId")
            ...
            modelBuilder.Entity("SalesManagement.DAL.Entities.Employee", b =>
                {
                    b.HasOne("SalesManagement.DAL.Entities.Shift", "Shift")
                        .WithMany("Employees")
                    ...
                    b.HasOne("SalesManagement.DAL.Entities.User", "User")
                        .WithOne("Employee")
                        .HasForeignKey("SalesManagement.DAL.Entities.Employee", "UserId")
            ...
            modelBuilder.Entity("SalesManagement.DAL.Entities.EmployeeSalaryComponent", b =>
                {
                    b.HasOne("SalesManagement.DAL.Entities.Employee", "Employee")
                        .WithMany("EmployeeSalaryComponents")
                        .HasForeignKey("EmployeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SalesManagement.DAL.Entities.SalaryComponent", "SalaryComponent")
                        .WithMany()
            ...
            modelBuilder.Entity("SalesManagement.DAL.Entities.InventoryTransaction", b =>
                {
                    b.HasOne("SalesManagement.DAL.Entities.User", "CreatedByNavigation")
                        .WithMany("InventoryTransactions")
                        .HasForeignKey("CreatedBy")
                        .HasConstraintName("FK__Inventory__Creat__75A278F5");

                    b.HasOne("SalesManagement.DAL.Entities.Product", "Product")
                        .WithMany("InventoryTransactions")
            ...
            modelBuilder.Entity("SalesManagement.DAL.Entities.Invoice", b =>
                {
                    b.HasOne("SalesManagement.DAL.Entities.Order", "Order")
                        .WithMany("Invoices")
            ...
            modelBuilder.Entity("SalesManagement.DAL.Entities.Order", b =>
                {
                    ...
                    b.HasOne("SalesManagement.DAL.Entities.Customer", "Customer")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("SalesManagement.DAL.Entities.OrderPromotion", b =>
                {
                    ...
                    b.HasOne("SalesManagement.DAL.Entities.Promotion", "Promotion")
                        .WithMany("OrderPromotions")
            ...
            modelBuilder.Entity("SalesManagement.DAL.Entities.Product", b =>
                {
                    b.HasOne("SalesManagement.DAL.Entities.Category", "Category")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("SalesManagement.DAL.Entities.Wallet", b =>
                {
                    b.HasOne("SalesManagement.DAL.Entities.Customer", "Customer")
                        .WithOne("Wallet")
                        .HasForeignKey("SalesManagement.DAL.Entities.Wallet", "CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("SalesManagement.DAL.Entities.WalletTransaction", b =>
                {
                    b.HasOne("SalesManagement.DAL.Entities.Invoice", "Invoice")
                        .WithMany()
                        .HasForeignKey("InvoiceId")
                        .HasConstraintName("FK_WalletTransactions_Invoices_InvoiceId");

                    b.HasOne("SalesManagement.DAL.Entities.Wallet", "Wallet")
